...
public class GeografijaDAO {
    ...
    private PreparedStatement glavniGradUpit, dajDrzavuUpit, obrisiDrzavuUpit, obrisiGradUpit,
            obrisiGradoveZaDrzavu, nadjiDrzavuUpit, dajGradoveUpit, dajDrzaveUpit, dodajGradUpit,
            odrediIdGradaUpit, dodajDrzavuUpit, odrediIdDrzaveUpit, promijeniGradUpit, dajGradUpit;
    ...
    // Takoder metoda za testove, regenirisi bazu nece ponovo napraviti tabele nego ce samo popuniti podacima
    // zbog CREATE TABLE IF NOT EXISTS. Ova metoda postoji da te tabele obrise kako bi se CREATE izvrsio
    ...
    // Takoder je i ova metoda dodana, zajedno sa obrisiGradUpit upitom
